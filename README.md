...
# IMPORTANT
Steam AGGRESSIVELY monitors any launched (child) process in many ways... As a result it may happen that if you want the "monitoring task" feature to work reliably, _launching Epic Games Launcher before and separately is the recommended solution_. If you won't launch EGL manually before the game, Steam unfortunately won't "release the game on quit" until you quit also EGL (that was launched automatically with the game, and will be seen as a component of the game still running). 
