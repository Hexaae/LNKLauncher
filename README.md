...
# IMPORTANT
Steam AGGRESSIVELY monitors any launched (child) process in many ways... As a result it may happen that if you want the "monitoring task" feature to work reliably, _launching Epic Games Launcher first and separately is the recommended solution_. If you won't launch EGL separately, Steam probably won't "release the game on quit" until you quit also EGL (launched automatically from the .url icon, seen as a componento of the game still running). 
